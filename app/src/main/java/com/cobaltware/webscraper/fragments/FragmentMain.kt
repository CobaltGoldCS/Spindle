...
class FragmentMain : Fragment() {
    ...
    /** Sets complex and long class parameters that would overcomplicate the [onCreateView] method*/
     ...
     */
    private fun initializeDropdownUI(v: View, books : List<String>, dropdownAdapter: ArrayAdapter<String>)
    {
        // Set Dropdown menu items and behavior
     ...
     * */
    private fun onDropdownItemClick(position: Int, dropdownAdapter: ArrayAdapter<String>, selectedTable : String)
    {
    ...
    private fun startPopup(adapter: ArrayAdapter<String>, title: String?)
    {
        ...
        menu.setOnDismissListener {
            ...
            if(menu.deleted)
            {
                onBookListsClick(1, adapter, viewer)
            }
        }
        menu.show()
    }
