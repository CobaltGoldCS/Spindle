...
open class ConfigAdapter(var configList: List<Config>) : RecyclerView.Adapter<ConfigAdapter.ItemHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.item_config_list,
            parent, false)
...
class ConfigCallback(private val newConfigs: List<Config>, private val oldConfigs: List<Config>) : DiffUtil.Callback()
{
